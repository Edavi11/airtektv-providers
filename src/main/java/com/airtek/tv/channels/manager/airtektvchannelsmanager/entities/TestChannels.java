...
@Getter
@Entity
@Table(name = "test_channels")
public class TestChannels implements Cloneable{
    @Id
    ...
    public TestChannels(String title, Categories fkCategory, String url, String backupUrl, String thumbnail) {
        this.title = title;
    ...
    public TestChannels(Integer id, String title, Categories fkCategory, String url, String backupUrl, String thumbnail) {
        this.id = id;
        this.title = title;
        this.fkCategory = fkCategory;
        this.url = url;
    ...
    @Override
    public TestChannels clone() {
        try {
            
            TestChannels cloned = (TestChannels) super.clone();
